 ...
 ### Example Django DRF codebase containing real world examples (CRUD, auth, advanced patterns, etc) that adheres to the [RealWorld]
## Installation

1. Clone this repository: `git clone git@github.com:narm2005/productionready-django-api.git`.
